    ...
    <div>
      <Swiper pagination={true} modules={[Pagination]}>
        <SwiperSlide className="swiperCod">
          <div className="flex flex-wrap w-[70%] opacity-80 bg-white border-mainRed border border-solid">
            <TeamSwiperPortraits
        ...
        <SwiperSlide className="swiperLol">
          <div className="flex flex-wrap w-[60%] opacity-80 bg-white border-mainRed border border-solid">
            <TeamSwiperPortraits
